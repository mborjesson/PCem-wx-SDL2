...
void fluidsynth_poll(midi_device_t* device)
{
        fluidsynth_t* data = (fluidsynth_t*)device->data;
        data->midi_pos++;
...
void fluidsynth_msg(midi_device_t* device, uint8_t* val)
{
        fluidsynth_t* data = (fluidsynth_t*)device->data;
...
void fluidsynth_sysex(midi_device_t* device, uint8_t* data, unsigned int len)
{
        fluidsynth_t* d = (fluidsynth_t*)device->data;
...
{
        fluidsynth_t* data = malloc(sizeof(fluidsynth_t));
